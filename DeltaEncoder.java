...
public class DeltaEncoder
{
	...
	public static void main(String[] args)
	{
		...
		DeltaEncoder analyzer = new DeltaEncoder(prefix + filename);
	}
	...
	public DeltaEncoder(String _filename)
	{
		...
		try
		{
			...
			if(raster_type == BufferedImage.TYPE_3BYTE_BGR)
			{
			    ...
			    JFrame frame = new JFrame("DeltaEncoder");
	...
	class ApplyHandler implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent event)
		{
			...
			for(int i = 0; i < 3; i++)
		    {
			    ...
			    if(channel_length[j] != channel_compressed_length[j])
			    {
					...
					if(number_unpacked != new_xdim * new_ydim)
					    ...
					    System.out.println("Unpacked strings after decompressing.");
			    }
			    else
			    {
			...
			{ 
				...
				red_green = (int [])resized_channel_list.get(2);
			...
			{ 
				blue       = (int [])resized_channel_list.get(0);
				red        = (int [])resized_channel_list.get(1);
				blue_green = (int [])resized_channel_list.get(2);
				green      = DeltaMapper.getDifference(blue, blue_green);
			}
			else if(min_set_id == 3)
			{ 
				blue       = (int [])resized_channel_list.get(0);
				blue_green = (int [])resized_channel_list.get(1);
				green      = DeltaMapper.getDifference(blue, blue_green);
				red_green  = (int [])resized_channel_list.get(2);
			...
			{ 
				...
				blue_green = (int [])resized_channel_list.get(1);
				green      = DeltaMapper.getDifference(blue, blue_green);
				red_blue   = (int [])resized_channel_list.get(2);
			...
			{
				green     = (int [])resized_channel_list.get(0);
				red_green = (int [])resized_channel_list.get(1);
				red       = DeltaMapper.getSum(green, red_green);
				red_blue  = (int [])resized_channel_list.get(1);
